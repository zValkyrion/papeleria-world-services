...
const DESC =
  "Aviso de privacidad de WORLD SERVICES: qué datos personales recabamos al cotizar proyectos de comunicación visual, con qué finalidad los usamos y cómo ejercer tus derechos ARCO.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: url("/aviso-privacidad") },
  openGraph: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: TITLE, item: url("/aviso-privacidad") },
  ],
};
